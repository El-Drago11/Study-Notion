...
const LearningLanguageSection = () => {
  return (
    <div className='w-11/12 max-w-maxContent flex flex-col mx-auto items-center mt-[130px]'>
        ...
        <div  className='text-sm text-center mt-4 w-[70%]'>
        Debugging is twice as hard as writing the code in the first place. Therefore, if you write the code as cleverly as possible, you are, by definition, not smart enough to debug it.
        </div>

        <div className='flex flex-row items-center justify-center mt-5 mx-auto'>
            <img src={knowYourProgress} alt='knowYourProgress' className='-mr-28 hover:scale-95 transition-x duration-200'/>
            <img src={compareWithOthers} alt='compareWithOthers' className='-mr-32 hover:scale-95 transition-x duration-200'/>
            <img src={planYourLesson} alt='planYourLesson' className='hover:scale-95 transition-x duration-200'/>
        </div>
