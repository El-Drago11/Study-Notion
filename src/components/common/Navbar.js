...
const Navbar = () => {
    ...
    return (
        <div className='flex h-[10vh] items-center justify-center border-b-2 border-b-richblack-100 '>
            <div className='flex w-11/12 max-w-maxContent items-center justify-between'>
                ...
                <nav>
                    <ul className='flex gap-x-4 text-richblack-25 mb-auto'>
                ...
                <div className='flex gap-x-4 items-center'>
                    {
                        user && user?.accountType != "Instructor" && (
                            <Link to="/dashboard/cart" className='relative text-richblack-5 text-3xl'>
                    ...
                    {
                        token === null && (
                            <Link to="/login" className='border border-richblack-700 bg-richblack-800 px-5 py-1 text-richblack-50 rounded-full hover:bg-richblack-900'>
                                <button>Login</button>
                            </Link>
                        )
                    }
                    {
                        token === null && (
                            <Link to="/signup" className='border border-richblack-700 bg-richblack-800 px-5 py-1 text-richblack-50 rounded-full hover:bg-richblack-900'>
                                <button>Sign Up</button>
                            </Link>
                        )
                    }
                    {token !=null && <Link to="/supportDesk" className='border border-richblack-700 bg-richblack-800 px-5 py-1 text-richblack-50 rounded-full hover:bg-richblack-900'>
                        <button className='capitalize'>supportDesk</button>
                    </Link>}
